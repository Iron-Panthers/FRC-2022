...
public class IntakeSubsystemTest {
  ...
  // // these two annotations tell junit to call the test repeatedly with the stream of arguments
  // from
  ...
  //   return Arguments.of(
  //       mode,
  //       new double[] {lowerIntakePercent, upperIntakePercent, rightEjectPercent,
  // leftEjectPercent});
  // }
