    ...
    public static final class Modules {
      public static final class FrontRight { // Module 1
        ...
        public static final double STEER_OFFSET =
            IS_COMP_BOT
                ? -Math.toRadians(225.2335) // comp bot offset
      ...
      public static final class FrontLeft { // Module 2
        ...
        public static final double STEER_OFFSET =
            IS_COMP_BOT
                ? -Math.toRadians(29.5257) // comp bot offset
      ...
      public static final class BackLeft { // Module 3
        ...
        public static final double STEER_OFFSET =
            IS_COMP_BOT
                ? -Math.toRadians(7.3746) // comp bot offset
      ...
      public static final class BackRight { // Module 4
        ...
        public static final double STEER_OFFSET =
            IS_COMP_BOT
                ? -Math.toRadians(20.3027) // comp bot offset
